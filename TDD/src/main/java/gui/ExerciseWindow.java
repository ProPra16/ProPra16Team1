...
import main.java.logic.ChartWindow;
import main.java.logic.Loader;
import main.java.logic.Timer;
import main.java.logic.Tracking;
import main.java.logic.TrackingInfo;
import main.java.logic.TrackingStore;
...
public class ExerciseWindow extends GridPane {
	private String css = this.getClass().getResource("/main/resources/layout/style.css").toExternalForm();
	private Stage stage;
	private Timer timer;
